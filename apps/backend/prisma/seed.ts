...
async function main(): Promise<void> {
  ...
  // =============================================
  const serviceData = [
    { providerId: providerProfiles[0].id, category: ServiceCategory.MAID,        title: 'Daily Cleaning',                   description: 'Full home cleaning service',          price: 800,  durationMinutes: 120 },
    { providerId: providerProfiles[1].id, category: ServiceCategory.MAID,        title: 'Daily Cleaning',                   description: 'Full home cleaning service',          price: 900,  durationMinutes: 120 },
    { providerId: providerProfiles[2].id, category: ServiceCategory.MAID,        title: 'Daily Cleaning',                   description: 'Full home cleaning service',          price: 750,  durationMinutes: 120 },
    { providerId: providerProfiles[3].id, category: ServiceCategory.COOK,        title: 'South Indian Breakfast & Lunch',   description: '2 meals per day',                     price: 1200, durationMinutes: 90  },
    { providerId: providerProfiles[4].id, category: ServiceCategory.COOK,        title: 'Full Day Cooking',                 description: 'Breakfast, lunch & dinner',           price: 1500, durationMinutes: 120 },
