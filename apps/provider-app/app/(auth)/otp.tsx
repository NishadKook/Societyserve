...
export default function OtpScreen() {
  ...
  const { setAuth, setProviderProfile, logout } = useAuthStore();
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (payload.role !== 'PROVIDER') {
        Alert.alert('Wrong App', 'This app is for service providers. Use the tenant app if you are a resident.');
        return;
      }
      ...
      const profile = meRes.data.providerProfile;
